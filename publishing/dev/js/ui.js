...
function introLogo() {
    $(window).scroll(function () {
        ...
        if (scrollHeight > 2) {
            ...
            $('.intro_artgg_img').removeClass('slideUp');
            $('.sectionDim').removeClass('fadeIn');
        } else if (scrollHeight < 1) {
            $('.intro_artgg_visual').removeClass('logo_motion');
            $('.wrap').removeClass('scolling');
            $('.intro_artgg_img').addClass('slideUp');
            $('.sectionDim').addClass('fadeIn');
        }
    });
}
    ...
    var mapData = [
        {
            ...
            place: {
                label: '안다즈서울강남스카이테라스펜트하우스', urls: [{ label: 'URL', url: 'http://naver.me/xXrEcDvc' }], places: []
            },
            about: '작년에 이어 두번째로 개최되었던 <업클로즈(UPCLOSE) 02>는 1973년 뉴욕현대미술관(MoMA) 펜트하우스에서 열렸던전시 <IMAGES>에서 영감을 받아 안다즈호텔 펜트하우스에서 진행되었습니다.<br>아트경기작가6인의 작품이 호텔의 감각적인 인테리어와 어우러져 탄생한 아트하우스에서 특별한 예술체험을 만끽할 수 있었습니다.',
            tip: [],
        ...
        },
        {
            ...
            place: {
                label: '파주헤이리예술마을', urls: [{ label: 'URL', url: 'http://naver.me/FyerVVNh' }], places: ['갤러리더차이', 'K-스페이스', '헤이리갤러리움', '카메라타갤러리', '갤러리소소', '범우재', '덩화나라']
            },
            about: '파주 자유로국도에서 이름을딴 "아트로드77"은 2009년 시작해 올해로 13회를 맞이하는 예술축제입니다.<br>예술로 하나가 되는 세상을 꿈꾸는 <아트경기x 트로드77>은 아트경기와 두해째 함께하며 아트경기를 대표하는 미술장터로 자리잡았습니다.',
            tip: [
                { label: '1. 아트경기의 아이덴티티', info: '아트경기 작가 42인 전원이 참여하는 미술장터에서 아트경기란 어떤사업인지 경험해보세요.' },
                { label: '2. 각양 각색의 일곱갤러리', info: '헤이리 예술마을내갤러리 7곳이 각각 풍기는 특유의 분위기를 느껴보세요.' },
                { label: '3. 다채로운 부대행사', info: '아트마켓과 미술전문가 강연, 작가와 함께하는 예술공방 등, 미술장터를 특별하게 만들어주는 부대행사들에 자유롭게참여보세요.' },
            ],
            more: ''
        },
        {
            ...
            place: {
                label: '평택송탄국제시장내전시공간', urls: [{ label: 'URL', url: 'http://naver.me/IgT5iaxE' }], places: []
            },
        ...
        },
        {
            ...
            place: {
                label: '현대백화점U-PLEX 중동점1층', urls: [{ label: 'URL', url: 'http://naver.me/501eqyRW' }], places: []
            },
            about: '어느덧 문화로 자리잡은 ‘플렉스(FLEX)’, 이제는 미술작품으로 ‘플렉스’ 해보세요. 소품 및 판화 그리고 아트포스터까지,  비교적 저렴한 가격의 아트상품을 소장하거나, 사랑하는 누군가에게 선물해보세요. ',
            tip: [
                { label: '1. 백화점에서 만나는 미술', info: '미술이 비싸고 부담스러웠다면,  현대백화점중동점에서 쇼핑하듯 편안하게 미술작품을 소장해보세요.' },
                { label: '2. 작품이 담긴 굿즈를 내곁에', info: '아트경기작가의 작품이 판화와 아트포스터, 다양한 아트굿즈로 여러분을 찾아갑니다.' },
                { label: '3. 리빙과 아트의 만남', info: '전시공간내 가구와 인테리어속에 자연스럽게 녹아든 미술품을 만나보세요.' },
            ],
            more: ''
        },
        {
            ...
            cooperation: '주관 : ㈜아트플레이스',
            place: {
                label: '플랫폼엘(Platform-L)', urls: [{ label: 'URL', url: 'http://naver.me/5JJQT6dz' }], places: []
            },
            ...
            tip: [
                { label: '1. 신과구의 연결고리', info: '협력사 추천 중견작가와 아트경기작가가 공존하는 전시로 시대별 작가간 교류의장을 경험해보세요.' },
                { label: '2. 미술시장 산책하기', info: '미술계 전문가가 들려주는 미술시장이야기를 통해 한발짝 더 미술시장에 다가가 보세요.' },
                { label: '3. 다채로운 형식의 작품', info: '평면뿐아니라 조각과 미디어아트에 이르는 다채로운작품들이 빚어내는 럭셔리한 전시를 감상해보세요.' },
            ],
            more: ''
        },
        {
            ...
            place: {
                label: '스튜디오끼, 문학수첩', urls: [{ label: '끼URL', url: 'http://naver.me/Fn2iCiP5' }, { label: '문학수첩URL', url: 'http://naver.me/5zJwUstd' }], places: []
            },
            about: 'DMZ 접경지역인 파주는 예로부터 경기북부 문화예술의 중심지였습니다.<br><DMZ 아트페어>는 파주를 기점으로 원로작가와 아트경기작가의 교류의장을 형성해 경기북부지역 문화예술을 재조명합니다.<br>지역문화생태계가 집중되는 예술축제가 여러분들을 찾아갑니다.',
            tip: [
                { label: '1. 아트와 플리마켓', info: '전시와 함께 지역상인들의 플리마켓 “끼마켓”을 즐겨보세요.' },
                { label: '2. 작가와의 토크쇼', info: '원로작가와 아트경기작가 사이에 오가는 진솔한이야기를 들어보세요. (유튜브라이브도진행한답니다!)' },
                { label: '3. 아트DMZ 포럼', info: '저명한 학예사와 평론가들이 한데모여 경기북부예술의 전망을 주제로 토론 및 강연을 진행합니다.' }
            ],
            more: ''
        },
        {
            ...
            cooperation: '주관 : KAN',
            place: {
                label: '경기도내 공공기관 및 기업', urls: [], places: []
            },
            about: '2021 아트경기 사업의 일환으로 도내공공기관내에 아트경기작가의 미술작품 임대 및 전시합니다.<br> 공기관으로 미술품수요를 확장하여 지속 가능한 예술문화를 만들어가는것을 목표로합니다.<br>각 공간에 적합한 큐레이팅을 통해 회화, 판화뿐 아니라 조각, 공예, 영상에 이르는 다양한 장르의 작품이 전시될 예정입니다.<br>동시에 작가에게는 판매 위주의 비연속적 마케팅 위주의 시장에서 지속 가능한 거래의 방향으로 지속적인 수입을 창출을 돕습니다.',
            tip: [],
            more: ''
        },
        {
            ...
            cooperation: '주관 : 스튜디오끼',
            place: {
                label: '유튜브"이광기의 광끼채널"', urls: [{ label: 'URL', url: ' https://www.youtube.com/channel/UCn9fY6_xBi7EV3K4hR14lWA' }], places: []
            },
            about: '작년부터 꾸준히 이어온 <이광기의Live 경매쇼>, 매경 매쇼 마다 동시접속자수는 꾸준히 증가하여 코로나19 이후 비대면시대 미술시장의 저변을 확대하고 있습니다.<br>격주 월요일마다 유튜브 “이광기의광끼채널” 에서 실시간으로 진행되는 경매쇼, 채팅을 통해 아트경기작가의 작품을 입찰해보세요.',
            tip: [{ label: '1. 침대에서 참여하는 경매', info: '경매를 위해 집을 떠날필요없이 어떤장소에서든 편하게 입찰에 참여해보세요.' },
            { label: '2. 작가를 영상으로 만나다', info: '매경 매쇼 전주에 작가 인터뷰가 업로드되고, 작가와 요리하며 대화를 나누는 “작가의레시피” 코너 또한 준비되어있습니다.' },
        ...
        },
        {
            ...
            place: {
                label: '오픈갤러리 홈페이지', urls: [{ label: 'URL', url: 'https://www.opengallery.co.kr' }], places: []
            },
            about: '오픈갤러리는 미술품 렌탈전문플랫폼으로, 원화를 렌탈하여 자신의 공간에 손쉽게 걸어둘수있습니다.<br> 9월말부터 아트경기작가의 작품을 대상으로 할인프로모션을 진행합니다.<br>저렴한 가격에 아트경기작가의 미술작품으로 집을 꾸며보세요.',
            tip: [{ label: '1. 작가 인터뷰', info: '오픈갤러리 SNS와 네이버포스트에서 작가의 작업과정과 작품세계를 접해보세요.' },
            { label: '2. 언제든 만날수있는 작품', info: '좋아하는 작가의 전시를 기다릴 필요없이 수많은 작품을 오픈갤러리 웹사이트에서 골라 대면해보세요.' },
            ],
            more: ''
        },
        {
            ...
            place: {
                label: '서울옥션 홈페이지', urls: [{ label: 'URL', url: 'https://www.seoulauction.com' }], places: []
            },
            about: '국내 최대 미술품 경매기업 "서울옥션"과의 제휴사업으로 온라인경매 <ZEROBASE x 아트경기>를 진행합니다.<br>"제로베이스" 는 0원부터 시작하는 경매로, 경매에 참여하는 아트경기작가 8인의 작품을 원하는 가격에 수월하게 입찰해볼수있습니다.특히 올해는 페르노리카코리아의 후원으로 더욱 풍성한 경매가 이루어질 예정입니다.',
            tip: [{ label: '1. 자유롭게 참여하는 입찰', info: '0원부터 순차적으로 올라가는 입찰가로 부담없이 경매에 참여할수있습니다.' },
            { label: '2. 프리뷰 전시', info: '경매전, 프리뷰 전시로 서울옥션강남센터에서 작품을 실물로 만나볼 수 있으니 놓치지마세요.' },
            { label: '3. 작가 인터뷰', info: '서울옥션에서 제작한 빼어난 영상미의 작가인터뷰 영상도 꼭 감상해보세요!' }
            ],
            more: ''
        },
        {
            ...
            place: {
                label: '대구컨벤션센터', urls: [{ label: 'URL', url: 'http://naver.me/xgauzKyf' }], places: []
            },
...
/**
 * 페이지 스크롤 단위 이동
 *  - github: https://github.com/Mobius1/Pageable
 */
// var gPageable = null;
