...
var MapControl = (function() {
    var mapData = [{
        ...
        },
        {
            ...
            about: '파주 자유로 국도에서 이름을 딴 "아트로드77"은 2009년 시작해 올해로 13회를 맞이하는 예술축제입니다.<br>예술로 하나가 되는 세상을 꿈꾸는 &lt;아트경기 x 트로드77&gt;은 아트경기와 두 해째 함께하며 아트경기를 대표하는 미술장터로 자리 잡았습니다.',
            tip: [
                { label: '1. 아트경기의 아이덴티티', info: '아트경기 작가 42인 전원이 참여하는 미술장터에서 아트경기란 어떤사업인지 경험해보세요.' },
                { label: '2. 각양 각색의 일곱 갤러리', info: '헤이리 예술마을내갤러리 7곳이 각각 풍기는 특유의 분위기를 느껴보세요.' },
                { label: '3. 다채로운 부대행사', info: '아트마켓과 미술전문가 강연 등, 미술장터를 특별하게 만들어주는 부대행사들에 자유롭게참여보세요.' },
            ],
            more: ''
        },
        {
        ...
        },
        {
            ...
            about: '2021 아트경기 사업의 일환으로 도내 공공기관 내에 아트경기작가의 미술작품 임대 및 전시합니다.<br> 공기관으로 미술품 수요를 확장하여 지속 가능한 예술 문화를 만들어가는 것을 목표로 합니다.<br>각 공간에 적합한 큐레이팅을 통해 회화, 판화뿐 아니라 조각, 공예, 영상에 이르는 다양한 장르의 작품이 전시될 예정입니다.<br>동시에 작가에게는 판매 위주의 비연속적 마케팅 위주의 시장에서 지속 가능한 거래의 방향으로 지속적인 수입을 창출을 돕습니다.',
            tip: [],
            more: ''
        },
        {
            ...
            about: '작년부터 꾸준히 이어온 &lt;이광기의 Live 경매쇼&gt;, 매 경매쇼마다 동시접속자 수는 꾸준히 증가하여 코로나19 이후 비대면시대 미술시장의 저변을 확대하고 있습니다.<br>격주 월요일마다 유튜브 “이광기의 광끼채널” 에서 실시간으로 진행되는 경매쇼, 채팅을 통해 아트경기 작가의 작품을 입찰해보세요.',
            tip: [{ label: '1. 침대에서 참여하는 경매', info: '경매를 위해 집을 떠날 필요 없이 어떤장소 에서든 편하게 입찰에 참여해보세요.' },
                { label: '2. 작가를 영상으로 만나다', info: '매 경매쇼 전주에 작가 인터뷰가 업로드되고, 작가와 요리하며 대화를 나누는 “작가의 레시피” 코너 또한 준비되어있습니다.' },
        ...
        },
        {
            ...
            about: '국내 최대 미술품 경매기업 "서울옥션"과의 제휴사업으로 온라인 경매 &lt;ZEROBASE x 아트경기&gt;를 진행합니다.<br>"제로베이스" 는 0원부터 시작하는 경매로, 경매에 참여하는 아트경기작가 8인의 작품을 원하는 가격에 수월하게 입찰해볼 수 있습니다. 특히 올해는 페르노리카 코리아의 후원으로 더욱 풍성한 경매가 이루어질 예정입니다.',
