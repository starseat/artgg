...
class Upload extends AdminController
{
	 ...
	 * 
	 * 이미지 업로드 처리
	 *  - 성공시 /upload/{target_type}/ 에 이미지 파일 업로드 후 경로 return
	 */
	public function image()
	{
		...
		if ($this->input->method() != 'post') {
			echo json_encode(makeResultErrorNotAllowedHttpMethod('Not allowed type. (Allow only POST method)'), JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
			exit();
		}
